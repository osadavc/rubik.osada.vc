  ...
  return (
    <StepContext.Provider value={contextValue}>
      <section
        ...
        className={`scroll-mt-[calc(42dvh+3rem)] space-y-5 py-14 transition-opacity duration-500 motion-reduce:transition-none lg:scroll-mt-32 lg:py-20 ${
      ...
      >
        ...
        {step.interaction === "execute" && <YourTurn />}
      </section>
